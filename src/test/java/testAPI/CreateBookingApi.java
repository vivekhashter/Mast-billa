...
public class CreateBookingApi {
    ...
    private CreateBookingApi() {}

    public static Response createBooking(String token) throws Exception {
...
//        System.out.println("API Body : " + jsonBody);
        ...
        Response response = obj.postWithToken(token, jsonBody, (ConfigFactory.getConfig().BASE_URL() + ConfigFactory.getConfig().BOOKING_ENDPOINT()))
        ...
        Assert.assertNotNull(jsonPath.getString("bookingid"));
        return response;
    }
